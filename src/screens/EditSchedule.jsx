...
const EditSchedule = ({ navigation,route }) => {
    ...
    PushNotification.getScheduledLocalNotifications((notifications) => {
     // console.log('All Scheduled Notifications:', notifications);
      ...
      if (notification) {
        ...
        setSelectedDay(notification.message)
        setSelectedTopic(notification.title)
       // return notification; // You can return or set the notification as needed
        setRepeatType(notification.repeatInterval)
        //setSelectedLanguage(notification.number)
        if( notification.number=='English'){
            setSelectedTable('Translation')
        }
        if( notification.number=='Urdu'){
            setSelectedTable('quran_urdu')
        }
        if( notification.number=='Arabic'){
            setSelectedTable('Quran')
        }
        const topic = ayattopiclist.find(item => item.topicName === notification.title);
        if (topic) {
  ...
  return (
    <ImageBackground source={require('../assets/CloudsBackground.png')} style={styles.bgImage}>
      ...
      <Text style={styles.heading}>Edit Ayat Schedule</Text>
      ...
      <Pressable style={styles.send} onPress={scheduleReminder}>
        <Text style={styles.sendText}>Update Schedule</Text>
      </Pressable>
